<img src="assets/header-terminal.svg?v=2.8" alt="terminal session - docker compose up, Qwen3.8-27B fine-tune pipeline, pnpm run deploy:prod" width="100%">
...
<img src="assets/ai-solutions.svg?v=2.8" alt="AI-integrated systems: transformer forward pass from business prompt to 5 autonomous output solutions" width="100%">
